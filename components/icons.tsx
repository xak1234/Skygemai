...
export const FirebaseIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className || "w-6 h-6"}>
        <path d="M6.912 3.731L17.27 21.318l-2.45-3.5L8.513 4.23zM5.52 8.358L8.13 18.5l-5.65-2.6z" fill="#FFCA28"></path>
        <path d="M2.5 15.9L8.13 18.5l-4.2-12.07z" fill="#FFA000"></path>
        <path d="M17.43 17.82l-9.92-14.09L15.39 2.4z" fill="#F57C00"></path>
        <path d="M8.13 18.5l9.14-17.18-7.83 14.36z" fill="#FFC107"></path>
    </svg>
);
